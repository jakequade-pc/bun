...
impl ErrorCode {
    ...
    pub const TLS_RENEGOTIATION_UNSUPPORTED: ErrorCode = ErrorCode(312);
    /// `ERR_TLS_INVALID_STATE` (instanceof Error)
    pub const TLS_INVALID_STATE: ErrorCode = ErrorCode(313);
    /// `ERR_TLS_ALPN_CALLBACK_INVALID_RESULT` (instanceof TypeError)
    pub const TLS_ALPN_CALLBACK_INVALID_RESULT: ErrorCode = ErrorCode(314);
